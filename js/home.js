function generateHomePage() {
    ...
    <div class="ppl3-parts-1cp">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>Monday, Dec. 25, 2023</td>
                    <td>Winter Holiday</td>
                </tr>
                <tr>
                    <td>Monday, Jan. 1, 2024</td>
                    <td>New Year's Day</td>
                </tr>
                <tr>
                    <td>Monday, Jan. 15, 2024</td>
                    <td>Martin Luther King Jr. Day</td>
                </tr>
                <tr>
                    <td>Monday, Feb. 19, 2024</td>
                ...
                <tr>
                    <td>Wednesday, Jun. 19, 2024</td>
                    <td>Juneteenth Holiday</td>
                </tr>
                <tr>
                    <td>Thursday, Jul. 4, 2024</td>
                    <td>Independence Day</td>
                </tr>
                <tr>
                    <td>Monday, Sept. 2, 2024</td>
                    <td>Labor Day</td>
                </tr>
                <tr>
                    <td>Monday, October 14, 2024</td>
                    <td>Library Staff Closure</td>
                </tr>
                <tr>
                    <td>Thursday, Oct. 31, 2024</td>
                    <td>Close at 5 p.m.</td>
                </tr>
                <tr>
                    <td>Monday, Nov. 11, 2024</td>
                    <td>Veterans Day</td>
                </tr>
                <tr>
                    <td>Wednesday, Nov. 27, 2024</td>
                    <td>Close at 5 p.m. (City Holiday)</td>
                </tr>
                <tr>
                    <td>Thursday, Nov. 28, 2024</td>
                    <td>Thanksgiving</td>
                </tr>
                <tr>
                    <td>Friday, Nov. 29, 2024</td>
                    <td>Thanksgiving</td>
                </tr>
                <tr>
                    <td>Tuesday, Dec. 24, 2024</td>
                    <td>Close at 12 p.m.</td>
                </tr>
                <tr>
                    <td>Wednesday, Dec. 25, 2024</td>
                    <td>Winter Holiday</td>
                </tr>
                <tr>
                    <td>Wednesday, Jan. 1, 2025</td>
                    <td>New Year's Day</td>
                </tr>
            </tbody>
        </table>
